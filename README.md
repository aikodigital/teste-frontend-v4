...
A página Home é a tela inicial que exibe um mapa interativo com a localização e o estado de diversos equipamentos. Utilizando a biblioteca react-leaflet para renderizar o mapa, a página apresenta informações em tempo real sobre os equipamentos cadastrados, como o tipo, a última posição e o histórico de estados.

Renderizado usando o componente MapContainer da biblioteca react-leaflet.
Marcadores de localização dos equipamentos, com ícones personalizados de acordo com o tipo de equipamento (e.g., caminhão, colhedora).

Marcadores com Popups:

Cada marcador exibe informações detalhadas do equipamento em um popup ao ser clicado, como:
Tipo de equipamento.
ID do equipamento.
Data da última atualização.
Estado atual (com cor e nome).
...
React-Leaflet:Biblioteca React usada para integrar o Leaflet, que fornece mapas interativos com suporte a marcadores, popups e camadas de mapa.
Versão: 4.2.1
Leaflet Versão: 1.9.4

React Icons: Biblioteca para exibir ícones SVG no React, como os ícones de caminhão e ferramentas.
Versão: 5.3.0
FontAwesome Icons são usados para ícones personalizados.

React Router Dom:Biblioteca de roteamento que gerencia a navegação entre as páginas do projeto.
Versão: 6.26.2
Tailwind CSS:

Framework CSS utilitário para criar rapidamente interfaces responsivas e estilizadas.
Versão: 3.4.11
